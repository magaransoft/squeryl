...
/**
 * An iterator that concatenates two iterators, yielding all elements from the first
 * followed by all elements from the second. Used internally to prepend a peeked-at
 * first element back onto a result set iterator.
 */
