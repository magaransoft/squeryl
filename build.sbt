...
val commonSettings = Def.settings(
  ...
  homepage := Some(url("https://github.com/magaransoft/squeryl")),
  pomExtra := (<scm>
               <url>git@github.com:magaransoft/squeryl.git</url>
               <connection>scm:git:git@github.com:magaransoft/squeryl.git</connection>
             </scm>
             <developers>
               <developer>
                 <id>NovaMage</id>
